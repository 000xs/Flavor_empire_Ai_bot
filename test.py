...
def upload_image_to_r2(image_bytes, file_name):
    ...
    try:
        ...
        public_url = (
            f"https://pub-{os.environ['R2_BUCKET_PUBLIC_URL']}.r2.dev/{file_name}"
        )
        ...
        print(
            "❌ Error: AWS credentials not found. Please check your environment variables."
        )
        return None
...
def main():
    ...
    file_name = "test.jpg"
    upload_image_to_r2(image_bytes, file_name)
    import os
